...
public class RewardController {
    ...
    @ResponseBody
    public Reward getRewardByID(@PathVariable("rID") int rID) {
    ...
    @ResponseBody
    public JsonStringWrapper createReward(@RequestBody Reward reward) throws ValidationException {
    ...
    @ResponseBody
    public void assignAwardToUser(@PathVariable("pID") int pID, @PathVariable("uID") String uID, @PathVariable("rID") int rID) {
    ...
    @ResponseBody
    public LinkedList<Reward> getRewardsByProjectAndUser(@PathVariable("pID") int pID, @PathVariable("uID") String uID)  {
    ...
    @ResponseBody
    public void deleteRewardByID(@PathVariable("rID") int rID)   {
